...
@st.cache_resource
def load_model():
    model = joblib.load("C:\\Users\\huzaifah_15\\OneDrive\\Desktop\\logistic regression\\logistic_regression_model.pkl")
    return model

# Load the dataset to get feature names
@st.cache_resource
def load_data():
    df = pd.read_csv("C:\\Users\\huzaifah_15\\OneDrive\\Desktop\\COE\\heart.csv.xls")
    return df
...
try:
    ...
    st.error(f"❌ Error: {e}")
    st.info("Make sure the model file is saved at: C:\\Users\\huzaifah_15\\OneDrive\\Desktop\\logistic regression\\logistic_regression_model.pkl")
